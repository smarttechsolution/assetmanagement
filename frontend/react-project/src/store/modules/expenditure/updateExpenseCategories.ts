...
export default function updateExpenseCategoriesReducer(
    state = initialState,
...
export const updateExpenseCategoriesAction = (id, requestData): AppThunk<APIResponseDetail<ExpenseCategories>> =>
