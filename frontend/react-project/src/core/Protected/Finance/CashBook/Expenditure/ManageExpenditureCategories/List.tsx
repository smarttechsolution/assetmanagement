...
import { deleteExpenseCategoriesAction } from "store/modules/expenditure/deleteExpenseCategory";
...
const List = (props: Props) => {
  ...
  const deletExpenseCategory = async () => {
    try {
      const response = await props.deleteExpenseCategoriesAction(editId);
  ...
  return (
    <div className="data-table mt-4">
      ...
      <ConfirmationModal
        ...
        handleConfirmClick={() => deletExpenseCategory()}
      />
    </div>
  );
};
