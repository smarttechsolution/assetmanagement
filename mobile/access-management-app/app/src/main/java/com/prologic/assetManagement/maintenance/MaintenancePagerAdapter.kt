...
class MaintenancePagerAdapter(fragment:FragmentActivity, val maintenances:List<MaintenanceFragment>) : FragmentStateAdapter(fragment) {
    override fun getItemCount(): Int {
        return maintenances.size
    }

    override fun createFragment(position: Int): Fragment {
        return maintenances[position]
    }
